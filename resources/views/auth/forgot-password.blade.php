...
<head>
    ...
    <title>InvoicePro - Forgot Password</title>
    ...
    <div class="max-w-md w-full mx-auto">
        <div class="glass-morphism rounded-3xl p-8">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600">Enter your email and we'll send you a password reset link.</p>
            </div>
            @if(session('status'))
            ...
            <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="john@example.com" class="input-field w-full px-4 py-3 rounded-xl border-0 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none">
                </div>
                <button type="submit" class="btn-primary w-full py-3 rounded-xl text-white font-semibold">Email Password Reset Link</button>
            </form>
